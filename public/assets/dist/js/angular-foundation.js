 ...
 */
  ...
  (function () {
      angular.module("mm.foundation.modal").run(["$templateCache", function ($templateCache) {
          $templateCache.put("template/modal/backdrop.html", "<div class=\"ui dimmer modals page active\" ng-click=\"close($event)\" ></div>\n");
          $templateCache.put("template/modal/window.html", "<div tabindex=\"-1\" class=\"ui modal active {{ windowClass }}\" ng-transclude>\n</div>\n");
      }]);
  })();
